(function() {
    ...
    class AppRouter extends HTMLElement {
        ...
        static get util() { return utilities; }
        ...
        importAndActivate(router, importUri, route, url, eventDetail) {
            var importLink;
        ...
        createModel(router, route, url, eventDetail) {
        ...
        activateElement(router, element, url, eventDetail) {
